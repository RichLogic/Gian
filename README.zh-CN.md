...
1. 从[当前 Beta Release](https://github.com/RichLogic/Gian/releases/tag/v0.2.1)下载 [`Gian-0.2.1-arm64.dmg`](https://github.com/RichLogic/Gian/releases/download/v0.2.1/Gian-0.2.1-arm64.dmg)。
