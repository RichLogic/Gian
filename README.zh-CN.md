...
1. 从[当前 Beta Release](https://github.com/RichLogic/Gian/releases/tag/v0.2.0)下载 [`Gian-0.2.0-arm64.dmg`](https://github.com/RichLogic/Gian/releases/download/v0.2.0/Gian-0.2.0-arm64.dmg)。
