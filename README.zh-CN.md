...
1. 从[当前 Beta Release](https://github.com/RichLogic/Gian/releases/tag/v0.4.4)下载 [`Gian-0.4.4-arm64.dmg`](https://github.com/RichLogic/Gian/releases/download/v0.4.4/Gian-0.4.4-arm64.dmg)。
