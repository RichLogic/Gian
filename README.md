...
<p align="center">
  <a href="https://github.com/RichLogic/Gian/releases/download/v0.2.1-hotfix/Gian-0.2.1-hotfix-arm64.dmg"><img src="https://img.shields.io/badge/Download_for_macOS-Gian_0.2.1--hotfix-E4572E?style=for-the-badge&logo=apple&logoColor=white" alt="Download Gian for macOS Apple Silicon"></a>
</p>

<p align="center">
  <a href="https://github.com/RichLogic/Gian/releases/tag/v0.2.1-hotfix"><img src="https://img.shields.io/badge/release-v0.2.1--hotfix_beta-C65D3A" alt="Current Gian beta release v0.2.1-hotfix"></a>
...
1. Download [`Gian-0.2.1-hotfix-arm64.dmg`](https://github.com/RichLogic/Gian/releases/download/v0.2.1-hotfix/Gian-0.2.1-hotfix-arm64.dmg) from the [current beta release](https://github.com/RichLogic/Gian/releases/tag/v0.2.1-hotfix).
