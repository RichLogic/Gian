...
1. Download [`Gian-0.1.2-arm64.dmg`](https://github.com/RichLogic/Gian/releases/download/v0.1.2/Gian-0.1.2-arm64.dmg) from the [current beta release](https://github.com/RichLogic/Gian/releases/tag/v0.1.2).
