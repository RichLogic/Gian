...
<p align="center">
  <a href="https://github.com/RichLogic/Gian/releases/download/v0.2.1/Gian-0.2.1-arm64.dmg"><img src="https://img.shields.io/badge/Download_for_macOS-Gian_0.2.1-E4572E?style=for-the-badge&logo=apple&logoColor=white" alt="Download Gian for macOS Apple Silicon"></a>
</p>

<p align="center">
  <a href="https://github.com/RichLogic/Gian/releases/tag/v0.2.1"><img src="https://img.shields.io/badge/release-v0.2.1_beta-C65D3A" alt="Current Gian beta release v0.2.1"></a>
...
1. Download [`Gian-0.2.1-arm64.dmg`](https://github.com/RichLogic/Gian/releases/download/v0.2.1/Gian-0.2.1-arm64.dmg) from the [current beta release](https://github.com/RichLogic/Gian/releases/tag/v0.2.1).
