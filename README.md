...
1. Download [`Gian-0.4.0-arm64.dmg`](https://github.com/RichLogic/Gian/releases/download/v0.4.0/Gian-0.4.0-arm64.dmg) from the [current beta release](https://github.com/RichLogic/Gian/releases/tag/v0.4.0).
