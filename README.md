...
<p align="center"><strong>One local desktop workspace for Codex, Claude Code, Kimi Code, DeepSeek Harness, and ZCode.</strong></p>
...
- Run Codex, Claude Code, Kimi Code, DeepSeek Harness, and ZCode from one consistent desktop interface.
...
| ZCode | Z.ai ZCode.app Agent runtime | Per-workspace app-server proxy |
