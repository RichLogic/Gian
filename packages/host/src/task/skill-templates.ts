...
- Create a subtask:
  \`<<gian:action>>{"method":"create_subtask","params":{"workspace":"<name|path>","executor":"claude|codex|kimi|dsh","brief":"<intent: goal / why / boundaries / where to look>","name":"<short>"}}<</gian:action>>\`
