...
`ai.deepseek.harness` — shared-scope Gian Proxy speaking `gian.proxy/2.0`
...
- `src/protocol/v2-adapter.ts` — `gian.proxy/2.0` dispatcher and capability
  narrowing.
...
The suite runs the complete `gian.proxy/2.0` contract through
