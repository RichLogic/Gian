...
export const EN: Messages = {
  ...
  'enrollment.title': 'Host registration',
  'enrollment.subtitle': 'Sign in with GitHub to mint a one-time enrollment token for your Gian.',
  'enrollment.remote': 'Remote control',
  'enrollment.server': 'Remote Server URL',
  'enrollment.generate': 'Generate enrollment token',
  'enrollment.generateAgain': 'Generate another token',
  'enrollment.singleUse': 'Single use',
  'enrollment.copy': 'Copy',
  'enrollment.copyCode': 'Copy code',
  'enrollment.copied': 'Copied',
  'enrollment.signOut': 'Sign out',
  'enrollment.pending': 'Please wait',
  'enrollment.expired': 'Expired',
  'enrollment.githubOpened': 'The GitHub authorization page opened in a new tab. Didn’t open? Use the button below.',
  'enrollment.waitingAuth': 'Waiting for GitHub authorization…',
  'enrollment.tokenHint': 'Paste this token into Gian Settings → “Connect Remote Server” within 5 minutes.',
  ...
  'enrollment.retrying': 'Sign-in connection interrupted. Retrying...',
  ...
  'account.authorize': 'Authorize on GitHub',
  'account.failed': 'Authorization failed or expired. Try again.',
  'pair.trust.note':
  ...
  'chat.context.pending': 'Context usage will appear after a response',
  'chat.context.usage': 'Context: {percent}% ({used} / {capacity} tokens)',
